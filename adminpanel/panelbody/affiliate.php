...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="offset-md-3 col-md-9 pc-content-header">
            ...
            <div class="col-md-12">
                <div class="breadcrumb-div">
                    <ul class="breadcrump">
                        ...
                        <li><a href="">Dashboard</a><i class="ph ph-caret-right"></i></li>
                        <li>Affilate Dashboard</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="page-header-tiitle">
                    <h2>Affilate Dashboard</h2>
                </div>
            </div>

            <div class="row">
                <div class="col-xxl-4 col-12">
                    <div class="static-card-affiliate">

                        <div class="card-body-affiliate">
                            <img src=".//affiliate.img/img-status-affiliate-1.4d72f177.svg" alt="">
