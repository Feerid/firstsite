<header class="appie-header">
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-10">
                <div class="appie-logo">
                ...
                <div class="col-2 d-block d-lg-none">
                    <button class="" id="menu_toggle"><i class="fa fa-bars"></i></button>
                </div>
            </div>

            <div class="col-md-6 col-12">
                <div class="menu-lt d-lg-block d-none" >
                    <ul>
                        <li>
                        ...
                        <li><a href="">Pages <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <div class="alt-home">
                                <ul>
                                    ...
                                    <li><a href="">Shops details</a></li>
                                </ul>
                            </div>
                        </li>
                        <li><a href="">News <i class="fa fa-angle-down" aria-hidden="true"></i></a></a>
                            <div class="alt-home">
                                <ul>
                                    <li><a href="<?=$base_url?>blog.php">News Page</a></li>
            ...
            <div class="col-md-4 col-12">
                <div class=login>
                    <a href="" class="login"><i class="fa fa-user log" aria-hidden="true"></i> Login</a>
                    <button class="btn btn-primary get">Get Started</button>
                </div>
